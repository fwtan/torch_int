...
torch::Tensor linear_a8_w8_b16_o16(torch::Tensor input,  // INT8
                                   torch::Tensor weight, // INT8
  ...
  using Gemm = cutlass::gemm::device::Gemm<
      ...
      // cutlass::epilogue::thread::FastLinearCombinationClamp<ElementOutput, 128 / cutlass::sizeof_bits<ElementOutput>::value>,
      cutlass::epilogue::thread::LinearCombinationClamp<ElementOutput, 128 / cutlass::sizeof_bits<ElementOutput>::value, ElementAccumulator, ElementComputeEpilogue>,
