...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("linear_a8_w8_b16_o16", &linear_a8_w8_b16_o16, "Linear (INT16)");
  ...
  m.def("dq_add_rmsnorm_q", &dq_add_rmsnorm_q,
        "DQ + Add + RMSNorm (INT8)");
  ...
  m.def("bmm_s8t_s8n_s32t_with_scaling", &bmm_s8t_s8n_s32t_with_scaling, "BMM (INT8 In Int32 Out) A x B.T");
  m.def("bmm_s8t_s8n_s16t", &bmm_s8t_s8n_s16t, "BMM (INT8 In Int16 Out) A x B.T");
}
